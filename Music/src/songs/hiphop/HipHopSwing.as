package songs.hiphop
{
	...
	public class HipHopSwing extends Song
	{
		private const ASSET_LOCATION:String = "HipHopSwing.swf"; 
		
		public function HipHopSwing()
		{
			super(AudioLibrary.SONG_HIPHOP_SWING, ASSET_LOCATION, [new ElectricPiano(), new Piano(), new Synth()]);
			name = "HipHop Swing";
