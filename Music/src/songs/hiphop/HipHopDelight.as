package songs.hiphop
{
	...
	public class HipHopDelight extends Song
	{
		private const ASSET_LOCATION:String = "HipHopDelight.swf"; 
		
		public function HipHopDelight()
		{
			super(AudioLibrary.SONG_HIPHOP_DELIGHT, ASSET_LOCATION, [new ElectricPiano(), new ElectricGuitar(), new Piano()]);
			name = "HipHop Delight";
