package songs.jazz
{
	...
	public class JazzDelight extends Song
	{
		private const ASSET_LOCATION:String = "JazzDelight.swf"; 
		
		public function JazzDelight()
		{
			super(AudioLibrary.SONG_JAZZ_DELIGHT, ASSET_LOCATION, [new Trombone(), new Trumpet(), new Saxophone()]);
			name = "Jazz Delight";
			...
			//3 - 4
			createSequence(["C", "V", "B", "C", "B"], ["02:44.183", "02:45.391", "02:46.025", "02:46.591", "02:47.816"], "2:53.650"); //FUCKED
		}
	}
}
